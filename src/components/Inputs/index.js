...
function Inputs () {
    return (
        <div>
            <p className="intro">Welcome to the boot camp resume&acute; builder, and interview prep site. I know what your thinking another one, but this one is different.
                ...
                Another thing that is different here is that not only can you build a resume&acute;
                 ,you can find interview prep questions, and the dreaded algorithms, which
